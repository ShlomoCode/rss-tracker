...
הגרסה הציבורית מכילה הגבלות שונות, הן בכמות הפידים שניתן להירשם אליהם, והן ברשימה לבנה של אתרים שאליהם ניתן להירשם. ניתן לארח את הפרויקט בצורה עצמאית ללא המגבלות הנ"ל.
